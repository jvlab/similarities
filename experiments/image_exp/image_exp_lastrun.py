...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/suniyya/Dropbox/Research/Thesis_Work/Psychophysics_Aim1/perceptual-similarities/experiments/image_exp/image_exp_lastrun.py',
...
start_up = visual.TextStim(win=win, name='start_up',
    ...
    font='Arial',
    pos=(0.7, 0), height=0.03, wrapWidth=None, ori=0, 
...
loading_msg = visual.TextStim(win=win, name='loading_msg',
    text='default text',
    font='Arial',
    pos=(0.65, 0), height=0.03, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=0.0);
import glob
...
page_num = visual.TextStim(win=win, name='page_num',
    text='default text',
    font='Arial',
    units='deg', pos=(34, -12), height=0.5, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-2.0);
